...
SimpleLoader::~SimpleLoader() {
    ...
    #define SIMPLE_LOADER_FUNCTION(name) \
        name((SIMPLE_LOADER_DECORATOR(name, type))lib.GetFunction(SIMPLE_LOADER_STRINGIFY(name)))
...
DRM_Proxy::DRM_Proxy()
        : lib("libdrm.so.2"),
          ...
          SIMPLE_LOADER_FUNCTION(drmModeAtomicAlloc),
          SIMPLE_LOADER_FUNCTION(drmModeAtomicAddProperty),
          SIMPLE_LOADER_FUNCTION(drmModeAtomicCommit),
          SIMPLE_LOADER_FUNCTION(drmModeAtomicFree),
          SIMPLE_LOADER_FUNCTION(drmModeCreatePropertyBlob),
          SIMPLE_LOADER_FUNCTION(drmModeObjectSetProperty),
          SIMPLE_LOADER_FUNCTION(drmModeDestroyPropertyBlob),
          SIMPLE_LOADER_FUNCTION(drmModeGetProperty),
          SIMPLE_LOADER_FUNCTION(drmModeFreeProperty),
          SIMPLE_LOADER_FUNCTION(drmModeGetPropertyBlob),
          SIMPLE_LOADER_FUNCTION(drmModeFreePropertyBlob),
...
VA_DRMProxy::VA_DRMProxy() : lib("libva-drm.so.2"), SIMPLE_LOADER_FUNCTION(vaGetDisplayDRM) {}
...
VAStatus CLibVA::AcquireVASurface(void** pctx,
                                  VADisplay dpy1,
                                  VASurfaceID srf1,
                                  VADisplay dpy2,
                                  VASurfaceID* srf2) {
...
void CLibVA::ReleaseVASurface(void* actx,
                              VADisplay dpy1,
                              VASurfaceID /*srf1*/,
                              VADisplay dpy2,
                              VASurfaceID srf2) {
